# https://github.com/jedahan/homebrew-cask/blob/53b6d134afb8d9ba2116a7be21a8852689ff09d7/Casks/r.rb
# this was removed from brew cask because it was considered a duplicate of the
# non-cask version. i do not agree.
...
cask "r" do
  if MacOS.version < :mavericks
    ...
    # cran.cnr.berkeley.edu was verified as official when first introduced to the cask
    url "https://cran.r-project.org/bin/macosx/R-#{version}.pkg"
    pkg "R-#{version}.pkg"
  end
